    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$d, 13, 0, 238);
    		},
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$c, 14, 1, 269);
    			attr_dev(h5, "class", "card-title svelte-o692v");
    			add_location(h5, file$c, 16, 2, 377);
    			attr_dev(p, "class", "card-text svelte-o692v");
    			add_location(p, file$c, 17, 2, 418);
    			attr_dev(div0, "class", "card-body svelte-o692v");
    			add_location(div0, file$c, 15, 1, 351);
    			attr_dev(div1, "class", "card svelte-o692v");
    			add_location(div1, file$c, 13, 0, 249);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$9, 20, 4, 353);
    			add_location(p1, file$9, 21, 4, 400);
    			attr_dev(div, "class", "footer svelte-1fvfbf0");
    			add_location(div, file$9, 19, 0, 328);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file$8, 7, 4, 105);
    			add_location(head, file$8, 6, 0, 94);
    			add_location(h1, file$8, 21, 8, 445);
    			attr_dev(div0, "class", "container py-4");
    			add_location(div0, file$8, 20, 4, 408);
    			add_location(h2, file$8, 27, 16, 639);
    			add_location(p, file$8, 28, 16, 678);
    			attr_dev(div1, "class", "container-fluid py-5");
    			add_location(div1, file$8, 26, 12, 588);
    			attr_dev(div2, "class", "p-5 mb-4 rounded-4 jumbotron svelte-ah2jr9");
    			add_location(div2, file$8, 25, 8, 533);
    			attr_dev(div3, "class", "container py-4");
    			add_location(div3, file$8, 24, 4, 496);
    			add_location(main, file$8, 19, 0, 397);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
