...
declare function createTabs(init?: Partial<Tabs>): {
    ...
    panel: (node: HTMLElement, value: any) => {
        destroy: () => void;
    };
...
export { Combobox, Dialog, Disclosure, Listbox, Menu, Popover, Switch, Tabs, createCombobox, createDialog, createDisclosure, createListbox, createMenu, createPopover, createSwitch, createTabs };
