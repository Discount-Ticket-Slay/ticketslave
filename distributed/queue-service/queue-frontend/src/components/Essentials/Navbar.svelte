        ...
        <div class="preview">
            <div class="nav-bar">
                ...
                <div class="nav-links">
                    ...
                    <a href="https://ticketslave.auth.ap-southeast-1.amazoncognito.com/login?client_id=4ash60bkicla7a4tdjdkob3pqu&response_type=code&scope=aws.cognito.signin.user.admin+email+openid+profile&redirect_uri=https%3A%2F%2Fwww.ticketslave.org%2Fauth%2Fcognito-callback" class="nav">Sign up/Log in</a>
                </div>
