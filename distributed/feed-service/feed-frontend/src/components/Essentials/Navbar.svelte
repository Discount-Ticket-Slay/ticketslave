    ...
    <div class="preview">
        <div class="nav-bar">
            ...
            <div class="nav-links">
                ...
                <a
                    href="https://cs203cry.auth.ap-southeast-1.amazoncognito.com/oauth2/authorize?client_id=38vedjrqldlotkn6g9glq0sq9n&response_type=code&scope=email+openid+phone&redirect_uri=https%3A%2F%2Fwww.ticketslave.org%2Ffeed%2Fauth%2Fcognito-callback"
                    class="nav">Sign up/Log in</a
                >
            </div>
            ...
            <form class="d-flex">
                <fieldset>
                    ...
                    <button name="go" id="go"><i class="fa fa-search" /></button
                    >
...
<style>
    ...
    :root {
        ...
        --clr-button: #272829;
        --clr-button-text: #fff;
        --clr-button-border: #454647;
        --clr-button-hover: #ff6200;
        --clr-button-glow: rgb(255, 134, 68);
        --clr-input: #272829;
        --clr-input-text: #c9ced3;
        --clr-input-placeholder: #fff;
        --clr-input-border: #454647;
    }
    ...
    * {
    ...
    button:focus {
        ...
        box-shadow: 0 0 8px var(--clr-button-glow);
    }
    ...
    input:valid + label {
        ...
        left: 217px;
        opacity: 1;
        /* transform: scale(0.6, 0.6) translate(-7px, -20px); */
